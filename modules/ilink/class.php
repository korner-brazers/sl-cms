...
class ilink{
    function init($sl,$moduleInfo = [],$ajaxLoad = false){
        ...
        $this->conf = SL_DATA.DIR_SEP.'ilink';
    }
    function clear(){
            ...
            foreach($_POST['status'] as $id=>$st){
                if(trim($_POST['get'][$id]) !== ''){
                    $b[$id] = [
                        ...
                        'more_param'=>str_replace('"',"'",$_POST['more_param'][$id]),
                        'status'=>intval($st)
                    ];
                }
            }
    ...
    function show(){
        ...
        $this->sl->scin->table_td_op(20,200,120,120,200,200,0);
        $this->sl->scin->table_head('',$lang[4],$lang[5],$lang[6],$lang[7],$lang[8],'');
        ...
        $this->sl->scin->table_dynamic([
            ...
            'more_param'=>function($v,$id){
                return $this->sl->scin->input('more_param['.$id.']',$v,['bigedit'=>true]);
            }
        ],[$lang[9]=>[3=>['onclick'=>"$(this).sl('_tbl_del_tr')"]]],$nar,[0,1000]);
    ...
    function add_row(){
        ...
        return $this->sl->scin->table_tr([
            ...
            $this->sl->scin->input('more_param['.$id.']','',['bigedit'=>true]),
